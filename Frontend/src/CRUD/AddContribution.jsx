...
function AddContribution() {
    ...
    const validateForm = () => {
        ...
        if (!inputs.Prompt_Pay) {
            errors.Prompt_Pay = "Prompt Pay is required";
        } else if (!/^\d+$/.test(inputs.Prompt_Pay) || inputs.Prompt_Pay.length !== 10) {
            errors.Prompt_Pay = "Prompt Pay must be a valid number with a length of 10";
        }
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        if (validateForm()) {
            axios.post('http://localhost:5000/add_contribution', inputs)
    ...
    return (
        <main className="bg-white-300 flex-1 p-3 overflow-hidden bg-[#f0f2f5]">
            <div className="flex flex-col">
                <div className="flex flex-1 py-4 text-[20px] font-bold ml-4">Add Post Contribution</div>
                            ...
                            <form className="px-5 py-5" onSubmit={handleSubmit}>
                                ...
                                <div className="md:flex mb-6">
                                    ...
                                    <div className="md:w-2/3">
                                        ...
                                        onChange={e => setInputs({...inputs, Prompt_Pay: e.target.value})}/>
                                        {formErrors.Prompt_Pay && (
                                            <p className="text-red-500 text-xs">{formErrors.Prompt_Pay}</p>
                                        )}
                                    </div>
                                </div>
                                <div className="md:flex mb-6">
