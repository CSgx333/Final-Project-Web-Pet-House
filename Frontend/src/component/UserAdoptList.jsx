...
function UserAdoptList({ setActiveTab }) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const accountData = allData.filter(item => item.Account_id === parseInt(UserId));
    ...
    const handleConfirm = (UserStatus, AdoptListId) => {
        Swal.fire({
            title: 'Are you sure ?',
                                                                    ...
                                                                    <div>
                                                                        <div className="flex items-center mt-4 bg-[#eef1f6] cursor-pointer text-gray-700 rounded-full" onClick={() => openModal(row.Account_id)}>
                                                                            <div className="flex-shrink-0 sm:pr-1 py-1 px-1">
                                                                                <img className="w-7 h-7 rounded-full" src={owner.UserImage} alt="User Image"/>
                                                                            </div>
                                                                            <div className="flex-1 min-w-0 ms-2">
                                                                                <p key={owner.Pet_adopt_id} className="text-[10px] sm:text-[10px] font-medium truncate">
                                                                        ...
                                                                        {isModalOpen && (
                                                                            <div className="fixed inset-0 overflow-y-auto z-50 flex items-center justify-center">
                                                                                ...
                                                                                <div className="bg-white p-5 rounded shadow-lg max-w-md w-full mx-auto z-50">
                                                                                    ...
                                                                                    <div className="flex items-center justify-center mt-5 b-4">
                                                                                        <img
                                                                                            className={`inline-block h-[120px] w-[120px] rounded-full ${
                                                                                                owner.Status === "ใช้งาน" ? "border-4 border-green-500" : ""
                                                                                            }`}
                                                                                            src={owner.UserImage}
                                                                                            alt="Account User"
                                                                                        />
                                                                                    </div>
                                                                                    <a className="flex items-center justify-center text-gray-700 text-[20px] font-bold">{owner.Name} {owner.Surname}</a>
                                                                                    <div className="rounded-md overflow-hidden border bg-[#ffffff] mt-3">
                                                                                        <div className="px-6 py-4">
                                                                                            ...
                                                                                            <div class="my-2">Email : {owner.Email}</div>
                                                                                            <div class="my-2">Telephone : {owner.Telephone}</div>
                                                                                            <div class="my-2">Province : {owner.UserProvince}</div>
                                                                                        </div>
