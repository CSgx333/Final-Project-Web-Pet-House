    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                // กรองจากชื่อ
                const dogName = dogData.filter(item =>
                    item.Pet_name.toLowerCase().includes(searchName.toLowerCase())
                );

                // กรองจากสายเพศ
                const dogGender = filterGender ? dogName.filter(item => item.Gender === filterGender) : dogName;

                // กรอง Status
                const dogStatus = dogGender.filter(item => item.Post_status === 1);
        ...
        <div class="bg-white p-3 shadow-md shadow-[#e9e9e9] rounded-lg">
                                ...
                                <div className="w-full mb-12 xl:mb-0 px-4 mx-auto mt-4">
                                    <div class="font-semibold mb-3">
                                        <i class="far fa-solid fa-dog mr-3"></i>
