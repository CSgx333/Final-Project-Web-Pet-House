...
function Contribution() {
    ...
    const [contributionEndData, setContributionEndData] = useState([]);
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                setContributionData(petStatus);
                setContributionEndData(filteredData)
            } catch (error) {
                ...
                <MiniMenu/>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                {!UserId ? (
                                    ...
                                    <div className="relative flex-grow flex-1 text-right">
                                        <button onClick={linkAddContribution} class="box-border z-30 inline-flex items-center justify-center w-auto px-6 py-2 overflow-hidden font-bold text-white transition-all duration-300 bg-indigo-600 rounded-md cursor-pointer group ring-offset-2 ring-1 ring-indigo-300 ring-offset-indigo-200 hover:ring-offset-indigo-500 ease focus:outline-none">
                        ...
                        {contributionData.length === 0 ? (
                            ...
                            currentPageData.map((row, index) => (
                                    <div key={index} className="p-2 cursor-pointer group" onClick={() => linkContributionProfile(row.Contribution_id)}>
                            ...
                            <div className="max-w-7xl mx-auto px-4 py-10 mt-8 sm:px-6 lg:px-8">
                                <div className="p-4 bg-white rounded-lg sm:p-8 bg-gradient-to-r from-[#39414c] to-[#161e28]">
                                    <div className="flex items-center justify-between mb-4">
                                        <h5 className="text-[14px] sm:text-[16px] font-bold leading-none text-gray-900 dark:text-white">Posts that are closed for contribution</h5>
                                    </div>
                                    <div className="flow-root">
                                            <ul role="list" class="divide-y divide-gray-200 dark:divide-gray-700">
                                                {contributionEndData.map((row, index) => (
